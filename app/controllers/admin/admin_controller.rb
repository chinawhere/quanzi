class Admin::AdminController < Admin::BaseController
  ...
  def update
    ...
    if password == params[:password_confirmation].strip and admin.update_attributes(password_hash: ha1(admin.name, 'Xiaojia', password))
  ...
  def do_login
    ...
    password_hash = ha1(name, 'Xiaojia', password)
